...
export default function DetailsScreen() {
  ...
  const getSocialMediaIcon = (social) => {
    switch (social) {
      ...
      case 'instagram':return require('../../assets/instagram.png');
      case 'linkedin': return require('../../assets/linkedin.png');
      default: return null;
    }
  };
...
const styles = StyleSheet.create({
  ...
  projectInfo: { flex: 1 },
  projectName: { fontWeight: 'bold', marginBottom: 5 },
  socialMediaIcons: { flexDirection: 'row', alignItems: 'center' },
  socialMediaIcon: { width: 36, height: 30, marginLeft: 10 },
});
